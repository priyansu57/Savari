    ...
    return (
        ...
        {!rideDetails || Object.keys(rideDetails).length === 0 ? (
            <div className='flex justify-center items-center h-[80vh]'> 
                ...
                <div className="w-xl h-auto  mr-0 flex flex-col   bg-white shadow-2xl shadow-blue-800 border-2 border-gray-200 rounded-2xl p-2 ">
                       {/* <div className='flex justify-between items-center'>
                                       ...
                                       <div className='flex flex-col justify-between items-center gap-2  p-6 '>
                                        ...
                                        {/* <div className="px-2 py-8  flex flex-row justify-center items-center gap-4 text-black text-center ">
                                            ...
                                            {/* <button  className="text-xl text-white font-semibold rounded-2xl bg-green-600 hover:bg-green-700 cursor-pointer  px-24 py-2  ">Confirm Ride</button> */}
                                        {/* </div> */}                
                </div>                    
                <div className='h-full w-full border-2 border-gray-200 rounded-2xl shadow-2xl '>
                    <RideMap
              pickup={
                rideDetails &&
