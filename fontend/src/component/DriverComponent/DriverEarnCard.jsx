    ...
    <div className="w-full sm:w-[600px] md:w-[700px] max-w-[90%] mx-auto fixed bottom-4 left-1/2 -translate-x-1/2 bg-white rounded-2xl shadow-lg overflow-hidden">
      ...
      <div className="flex justify-between items-center pl-4 pr-4">
        ...
        <div className="flex flex-col items-center cursor-pointer relative">
          ...
          {/* <div className="absolute -top-2 w-28 h-8 bg-blue-300/40 rounded-full blur-md"></div>
        ...
        {/* Earnings */}
        <div className="text-right">
          <p className="text-lg sm:text-xl font-semibold">$325.00</p>
          <p className="text-sm text-gray-400">Earned</p>
        </div>
      </div>
      ...
      <AnimatePresence>
        {visible && (
          <motion.div
            ...
            className="bg-gray-900 grid grid-cols-3 text-center py-4 sm:py-6"
          >
            <div>
              <FaClock className="mx-auto mb-2 text-white" size={22} />
              <p className="text-sm sm:text-lg font-bold text-white">10.2</p>
              <p className="text-xs text-white">HOURS ONLINE</p>
            </div>
            <div>
              <FaTachometerAlt className="mx-auto mb-2 text-white" size={22} />
              <p className="text-sm sm:text-lg font-bold text-white">30 KM</p>
              <p className="text-xs text-white">TOTAL DISTANCE</p>
            </div>
            <div>
              <FaClipboardList className="mx-auto mb-2 text-white" size={22} />
              <p className="text-sm sm:text-lg font-bold text-white">20</p>
              <p className="text-xs text-white">TOTAL JOBS</p>
            </div>
          </motion.div>
        )}
