        ...
        <div className="flex flex-col justify-center items-center ">
            ...
            <div  className="flex h-[700px] w-full  ">
                ...
                <div  className="w-full hidden md:flex  items-center ">
                    <img  className="h-96 w-[80%]" src="https://cn-geo1.uber.com/image-proc/crop/resizecrop/udam/format=auto/width=552/height=552/srcb64=aHR0cHM6Ly90Yi1zdGF0aWMudWJlci5jb20vcHJvZC91ZGFtLWFzc2V0cy80MmEyOTE0Ny1lMDQzLTQyZjktODU0NC1lY2ZmZmUwNTMyZTkucG5n" alt="leftSideImage" />
                </div>

            </div>
                    <button type="submit" onClick={() => navigate("/captain-login")} className=" w-[50%] md:w-2xl h-11 rounded-full text-white bg-black hover:opacity-90 transition-opacity">
                        Captain  Login
                        </button>
            </div>
        </>
